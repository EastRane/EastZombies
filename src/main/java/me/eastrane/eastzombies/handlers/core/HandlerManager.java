package me.eastrane.eastzombies.handlers.core;
...
import me.eastrane.eastzombies.utilities.DebugProvider;
    ...
    private void registerHandlers() {
        ...
        if (configProvider.isVoicePersistentGroups()) {
            try {
                ...
                Class<?> voiceHandlerClass = Class.forName("me.eastrane.eastzombies.handlers.VoiceHandler");
